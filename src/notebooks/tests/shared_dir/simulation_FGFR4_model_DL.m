...
x0s = transpose(table2array(init_conditions_table(1,2:end)));
...
%% Calculate dynamic features based on readouts
% AUC, Time_to_max, max, Time_to_min, min, mean, median, tfc, tsv

dynamic_feature_labels = {'auc', 'median', 'tfc', 'tmax', 'max', 'tmin', 'min', 'tsv', 'ttsv', 'init'};
...
for i = 1:width(tbl)
    ...
    dynamic_features(i,:) = {n_auc, median_val, tfc, n_max_time, max_val, n_min_time, min_val, tsv, tsv_value, start_val};
end
