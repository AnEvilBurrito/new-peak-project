...
# Batch Response Noise Execution Script
# Section 4 / Experiment 03 / Version 1

# Set script variables with absolute paths
VENV_PATH="/home/dawsonlan/new-peak-project/.venv/bin/activate"
PYTHON_SCRIPT="/home/dawsonlan/new-peak-project/src/scripts/4_03_v1_batch-response-noise.py"
PROJECT_DIR="/home/dawsonlan/new-peak-project"

echo "🚀 Starting Batch Response Noise Execution via Shell Script"
