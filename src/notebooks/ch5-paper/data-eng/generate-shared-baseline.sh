...
PYTHON_SCRIPT="/home/dawsonlan/new-peak-project/src/notebooks/ch5-paper/data-eng/generate-shared-baseline.py"
PROJECT_DIR="/home/dawsonlan/new-peak-project"

echo "🚀 Starting Shared Baseline Generation Execution via Shell Script"
...
if [ $PYTHON_EXIT_CODE -eq 0 ]; then
    echo "✅ Shared baseline generation completed successfully via shell script"
else
    echo "❌ Shared baseline generation failed with exit code: $PYTHON_EXIT_CODE"
fi
